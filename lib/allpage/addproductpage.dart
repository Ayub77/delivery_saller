  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Yangi mahsulot qo'shish"),
        centerTitle: true,
      ),
      body: Container(
              ...
              child: InkWell(
                onTap: () async{
                  ...
                  if (title.isEmpty ||
                    ...
                    var res = await NetworkPosts.postApi(Api.products, Params.sendProductParams(title, categoryId.toString(), typeId.toString(), cost, count));
